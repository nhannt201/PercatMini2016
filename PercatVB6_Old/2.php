...
echo "I know that I manage my time well because I知 never late to work and I never missed dealine. I always make a planning out what I have to do for the whole week.";
elseif ($chat == "what do you think makes you a good fit for this company")
echo "I have experience about 2 years in maketing and I知 a dynamic, creative and friendly person. Besides that, I知 a team player who has been interpersonal skills. So I think that I知 a good fit for this position.";
elseif ($chat == "what are your weaknesses")
echo "This might be bad, but when I studied in university I found that I was not being detail oriented enough. I always want to accomplish as much as possible. But I realized this hurts the quality and I知 currently working on finding a balance between quantity and quanlity.";
...
echo "My long term goal is to become Marketing director or higher. This might be a little ambitious, but I think I知 going to work hard, learn everything I can and contributing to a company where I値l become a valuable asset. I know that it痴 not a eassy job but I think I can do by myself.";
