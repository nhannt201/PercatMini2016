...
elseif ($chat == "singer")
echo "listen to this lá lá lá lá là la la";
elseif ($chat == "sing")
...
echo "That's not cool.";
elseif ($chat == "you're so annoying")
echo "á á á overheating";
